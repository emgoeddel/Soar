...
if compiler == 'g++':
    ...
    if GetOption('useros'):
        ...
        libs += ['roscpp', 'pcl_common', 'ompl', 'urdf', 'geometric_shapes', 'fcl', 'orocos-kdl', 'kdl_parser', 'actionlib']
    ...
    if GetOption('useros'):
        ...
        libs += ['roscpp', 'libpcl_common', 'ompl', 'urdf', 'geometric_shapes', 'fcl', 'orocos-kdl', 'kdl_parser', 'actionlib']
    if GetOption('defflags'):
        if GetOption('dbg'):
